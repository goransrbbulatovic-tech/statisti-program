export const GRADIENTS = {
  ...
  'cosmos':     'radial-gradient(2px 2px at 12% 22%,#fff 0%,transparent 100%),radial-gradient(1px 1px at 52% 8%,#fff 0%,transparent 100%),radial-gradient(2px 2px at 78% 62%,#ddd 0%,transparent 100%),radial-gradient(1px 1px at 33% 80%,#ccc 0%,transparent 100%),radial-gradient(3px 3px at 48% 44%,rgba(147,197,253,0.7) 0%,transparent 100%),radial-gradient(ellipse at 28% 38%,rgba(30,80,220,0.35) 0%,transparent 50%),radial-gradient(ellipse at 72% 72%,rgba(110,40,220,0.3) 0%,transparent 50%),linear-gradient(155deg,#010307 0%,#020411 50%,#010207 100%)',
  ...
  'neon-city':  'radial-gradient(ellipse at 8% 92%,rgba(236,72,153,0.45) 0%,transparent 38%),radial-gradient(ellipse at 92% 8%,rgba(34,211,238,0.4) 0%,transparent 38%),radial-gradient(ellipse at 50% 50%,rgba(139,92,246,0.22) 0%,transparent 52%),linear-gradient(155deg,#020107 0%,#04020c 50%,#010107 100%)',
...
export function getBgStyle(bgTheme, bgCustomUrl) {
  if (!bgTheme || bgTheme === 'none') return null
  if (bgTheme === 'custom' && bgCustomUrl) {
    return `linear-gradient(rgba(0,0,0,0.50),rgba(0,0,0,0.50)),url("${bgCustomUrl}")`
  }
  return GRADIENTS[bgTheme] || null
}
